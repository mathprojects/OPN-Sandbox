...
(* The following 3 functions are available in MPIR but not GMP *)
{$IFDEF MPIR}
...
{$ENDIF}
{$IFDEF GMP}
(* The following 2 functions are in GMP but may not be avilable in MPIR *)
function mpz_probab_prime_p(var Src: mpz_t; Reps: Integer): Integer; cdecl; external GMP_LIB_FILE name '__gmpz_probab_prime_p';
procedure mpz_nextprime(var Dest: mpz_t; var Src: mpz_t); cdecl; external GMP_LIB_FILE name '__gmpz_nextprime';
{$ENDIF}
...
procedure mpz_urandomb(var ROP: mpz_t; var State: gmp_randstate_t; n: mp_bitcnt_t); cdecl; external GMP_LIB_FILE name '__gmpz_urandomb';
...
procedure mpz_rrandomb(var ROP: mpz_t; var State: gmp_randstate_t; n: mp_bitcnt_t); cdecl; external GMP_LIB_FILE name '__gmpz_rrandomb';
